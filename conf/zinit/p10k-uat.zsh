# Generated by Powerlevel10k configuration wizard on 2024-10-22 at 02:08 UTC.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 44011.
# Wizard options: ascii, rainbow, 12h time, 2 lines, solid, dark-ornaments, compact,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_BACKGROUND='%K{27}'
