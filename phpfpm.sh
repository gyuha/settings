...
copyconf() {
	...
	msg "Nginx"
	curl -L https://raw.githubusercontent.com/gyuha/settings/master/conf/nginx > /tmp/nginx.conf
	...
	curl -L https://raw.githubusercontent.com/gyuha/settings/master/conf/php.dev.ini > /tmp/php.dev.ini
